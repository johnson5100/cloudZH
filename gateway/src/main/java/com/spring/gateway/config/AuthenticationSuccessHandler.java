...
import com.spring.gateway.entity.AuthUserDetails;
import com.spring.gateway.response.MessageCode;
import com.spring.gateway.response.WsResponse;
...
public class AuthenticationSuccessHandler extends WebFilterChainServerAuthenticationSuccessHandler
{
    ...
    private AuthUserDetails buildUser(User user){
        ...
        userDetails.setPassword(user.getPassword().
                substring(user.getPassword().lastIndexOf("}") + 1, user.getPassword().length()));
        return userDetails;
    }
